...
def level():
    ...
    return LevelLa;            
    # Read the data and calcualte the left mono level
...
def load_images():
    ...
    return {'background': load_image('Test.jpg'),
            'pipe-end': load_image('end.png'),
            'pipe-body': load_image('body.png'),
            # images for animating the flapping bird -- animated GIFs are
            # not supported in pygame
            'bird-wingup': load_image('Georges.png'),
            'bird-wingdown': load_image('Georges.png')}
...
def main():
    ...
    pygame.display.set_caption('Flappy Georges')

    clock = pygame.time.Clock()
    score_font = pygame.font.SysFont(None, 64, bold=True)  # default font
    images = load_images()
